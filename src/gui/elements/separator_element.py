...
class HSeparatorElement(IElement):
	def __init__(self, width: int, color: tuple[int, int, int], *, left: int = None, right: int = None, top: int = None, bottom: int = None):
		super().__init__(
			left=left,
			right=right,
			top=top,
...
class VSeparatorElement(IElement):
	def __init__(self, height: int, color: tuple[int, int, int], *, left: int = None, right: int = None, top: int = None, bottom: int = None):
		super().__init__(
			left=left,
			right=right,
			top=top,
